...
public class RealmsBackupScreen extends RealmsScreen {
    ...
    public void init() {
        ...
        this.downloadButton = linearlayout.addChild(
            Button.builder(Component.translatable("mco.backup.button.download"), p_88185_ -> this.downloadClicked()).build()
        );
        ...
        public Entry(Backup p_88250_) {
            ...
            if (!p_88250_.changeList.isEmpty()) {
                this.restoreButton = Button.builder(
                        ...
                        p_329643_ -> RealmsBackupScreen.this.minecraft.setScreen(new RealmsBackupInfoScreen(RealmsBackupScreen.this, this.backup))
                    )
            ...
            if (!RealmsBackupScreen.this.serverData.expired) {
                this.changesButton = Button.builder(RealmsBackupScreen.RESTORE_TOOLTIP, p_329642_ -> this.restoreClicked())
                    .width(8 + RealmsBackupScreen.this.font.width(RealmsBackupScreen.HAS_CHANGES_TOOLTIP))
                    .createNarration(
