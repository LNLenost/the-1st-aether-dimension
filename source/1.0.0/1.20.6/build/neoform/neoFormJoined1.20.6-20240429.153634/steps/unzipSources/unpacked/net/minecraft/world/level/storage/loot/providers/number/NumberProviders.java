...
public class NumberProviders {
    ...
    private static LootNumberProviderType register(String p_165739_, MapCodec<? extends NumberProvider> p_338305_) {
        return Registry.register(BuiltInRegistries.LOOT_NUMBER_PROVIDER_TYPE, new ResourceLocation(p_165739_), new LootNumberProviderType(p_338305_));
    }
}
