...
public class MapRenderer implements AutoCloseable {
    ...
    private MapRenderer.MapInstance getOrCreateMapInstance(MapId p_323495_, MapItemSavedData p_168780_) {
        return this.maps.compute(p_323495_.id(), (p_182563_, p_182564_) -> {
            if (p_182564_ == null) {
        ...
        void draw(PoseStack p_93292_, MultiBufferSource p_93293_, boolean p_93294_, int p_93295_) {
            ...
            for (MapDecoration mapdecoration : this.data.getDecorations()) {
                if (!p_93294_ || mapdecoration.renderOnFrame()) {
                    ...
                    vertexconsumer1.vertex(matrix4f1, -1.0F, 1.0F, (float)k * -0.001F).color(255, 255, 255, 255).uv(f2, f3).uv2(p_93295_).endVertex();
                    vertexconsumer1.vertex(matrix4f1, 1.0F, 1.0F, (float)k * -0.001F).color(255, 255, 255, 255).uv(f4, f3).uv2(p_93295_).endVertex();
                    vertexconsumer1.vertex(matrix4f1, 1.0F, -1.0F, (float)k * -0.001F).color(255, 255, 255, 255).uv(f4, f5).uv2(p_93295_).endVertex();
                    vertexconsumer1.vertex(matrix4f1, -1.0F, -1.0F, (float)k * -0.001F).color(255, 255, 255, 255).uv(f2, f5).uv2(p_93295_).endVertex();
                    p_93292_.popPose();
