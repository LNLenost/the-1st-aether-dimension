...
public class GoatAi {
    ...
    private static final TargetingConditions RAM_TARGET_CONDITIONS = TargetingConditions.forCombat()
        .selector(p_337840_ -> !p_337840_.getType().equals(EntityType.GOAT) && p_337840_.level().getWorldBorder().isWithinBounds(p_337840_.getBoundingBox()));
            ...
            ImmutableList.of(
                Pair.of(
                    ...
                    new RamTarget(
                        ...
                        3.0F,
                        p_330059_ -> p_330059_.isBaby() ? 1.0 : 2.5,
    ...
    public static Predicate<ItemStack> getTemptations() {
        return p_335268_ -> p_335268_.is(ItemTags.GOAT_FOOD);
    }
}
