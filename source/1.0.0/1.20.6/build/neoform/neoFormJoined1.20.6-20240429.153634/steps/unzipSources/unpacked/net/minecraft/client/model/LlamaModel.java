...
public class LlamaModel<T extends AbstractChestedHorse> extends EntityModel<T> {
    ...
    public void renderToBuffer(
        PoseStack p_103056_, VertexConsumer p_103057_, int p_103058_, int p_103059_, float p_103060_, float p_103061_, float p_103062_, float p_103063_
    ) {
        if (this.young) {
            float f = 2.0F;
            p_103056_.pushPose();
            ...
            ImmutableList.of(this.rightHindLeg, this.leftHindLeg, this.rightFrontLeg, this.leftFrontLeg, this.rightChest, this.leftChest)
                .forEach(p_103083_ -> p_103083_.render(p_103056_, p_103057_, p_103058_, p_103059_, p_103060_, p_103061_, p_103062_, p_103063_));
            p_103056_.popPose();
        } else {
            ImmutableList.of(this.head, this.body, this.rightHindLeg, this.leftHindLeg, this.rightFrontLeg, this.leftFrontLeg, this.rightChest, this.leftChest)
                .forEach(p_103073_ -> p_103073_.render(p_103056_, p_103057_, p_103058_, p_103059_, p_103060_, p_103061_, p_103062_, p_103063_));
        }
    }
}
