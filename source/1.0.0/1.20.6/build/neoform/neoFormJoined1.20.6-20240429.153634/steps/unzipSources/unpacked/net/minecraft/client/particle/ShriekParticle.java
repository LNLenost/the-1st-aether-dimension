...
public class ShriekParticle extends TextureSheetParticle {
    ...
    public void render(VertexConsumer p_233985_, Camera p_233986_, float p_233987_) {
        if (this.delay <= 0) {
            ...
            this.renderRotatedParticle(p_233985_, p_233986_, p_233987_, p_253347_ -> p_253347_.mul(new Quaternionf().rotationX(-1.0472F)));
            this.renderRotatedParticle(
                p_233985_, p_233986_, p_233987_, p_253346_ -> p_253346_.mul(new Quaternionf().rotationYXZ((float) -Math.PI, 1.0472F, 0.0F))
            );
        }
    }
