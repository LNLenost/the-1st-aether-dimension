...
public class TradeRebalanceChestLoot implements LootTableSubProvider {
    @Override
    public void generate(HolderLookup.Provider p_330222_, BiConsumer<ResourceKey<LootTable>, LootTable.Builder> p_301981_) {
        p_301981_.accept(
                    ...
                    LootPool.lootPool()
                        ...
                        .add(
                            LootItem.lootTableItem(Items.BOOK)
                                .setWeight(1)
                                .apply(new EnchantRandomlyFunction.Builder().withEnchantment(Enchantments.EFFICIENCY))
                        )
                )
        );
        p_301981_.accept(BuiltInLootTables.ANCIENT_CITY, ancientCityLootTable());
        p_301981_.accept(BuiltInLootTables.DESERT_PYRAMID, desertPyramidLootTable());
        p_301981_.accept(BuiltInLootTables.JUNGLE_TEMPLE, jungleTempleLootTable());
        p_301981_.accept(BuiltInLootTables.PILLAGER_OUTPOST, pillagerOutpostLootTable());
    }
        ...
        return LootTable.lootTable()
            ...
            .withPool(
                LootPool.lootPool()
                    ...
                    .add(
                        LootItem.lootTableItem(Items.BOOK).setWeight(2).apply(new EnchantRandomlyFunction.Builder().withEnchantment(Enchantments.QUICK_CHARGE))
                    )
            );
    }
