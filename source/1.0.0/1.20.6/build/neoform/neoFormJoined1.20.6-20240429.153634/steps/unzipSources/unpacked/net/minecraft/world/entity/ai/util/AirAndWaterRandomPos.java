...
public class AirAndWaterRandomPos {
    ...
    public static Vec3 getPos(PathfinderMob p_148358_, int p_148359_, int p_148360_, int p_148361_, double p_148362_, double p_148363_, double p_148364_) {
        ...
        return RandomPos.generateRandomPos(
            p_148358_, () -> generateRandomPos(p_148358_, p_148359_, p_148360_, p_148361_, p_148362_, p_148363_, p_148364_, flag)
        );
    }
    ...
    public static BlockPos generateRandomPos(
        ...
        BlockPos blockpos = RandomPos.generateRandomDirectionWithinRadians(
            p_148366_.getRandom(), p_148367_, p_148368_, p_148369_, p_148370_, p_148371_, p_148372_
        );
        if (blockpos == null) {
            return null;
        } else {
