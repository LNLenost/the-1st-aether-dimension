...
public class ReportPlayerScreen extends Screen {
    ...
    public ReportPlayerScreen(Screen p_299954_, ReportingContext p_299878_, PlayerEntry p_299949_) {
        super(TITLE);
        this.lastScreen = p_299954_;
        this.context = p_299878_;
        this.player = p_299949_;
    }
    ...
    protected void init() {
        ...
        this.layout.visitWidgets(p_321362_ -> {
            AbstractWidget abstractwidget = this.addRenderableWidget(p_321362_);
        });
