...
public record AdvancementRewards(int experience, List<ResourceKey<LootTable>> loot, List<ResourceLocation> recipes, Optional<CacheableFunction> function) {
    ...
    public void grant(ServerPlayer p_9990_) {
        ...
        this.function
            ...
            .ifPresent(
                p_337338_ -> minecraftserver.getFunctions()
                        .execute((CommandFunction<CommandSourceStack>)p_337338_, p_9990_.createCommandSourceStack().withSuppressedOutput().withPermission(2))
            );
    }
    ...
    public static class Builder {
        ...
        public static AdvancementRewards.Builder loot(ResourceKey<LootTable> p_335493_) {
            return new AdvancementRewards.Builder().addLootTable(p_335493_);
        }

        public AdvancementRewards.Builder addLootTable(ResourceKey<LootTable> p_335822_) {
            this.loot.add(p_335822_);
            return this;
        }
