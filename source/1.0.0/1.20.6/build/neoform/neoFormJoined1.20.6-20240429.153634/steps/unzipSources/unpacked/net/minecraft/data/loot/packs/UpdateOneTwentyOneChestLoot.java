...
public class UpdateOneTwentyOneChestLoot implements LootTableSubProvider {
    @Override
    public void generate(HolderLookup.Provider p_331408_, BiConsumer<ResourceKey<LootTable>, LootTable.Builder> p_312616_) {
        p_312616_.accept(
                ...
                .withPool(
                    LootPool.lootPool()
                        ...
                        .add(
                            LootItem.lootTableItem(Items.BOOK)
                                .setWeight(1)
                                .apply(new EnchantRandomlyFunction.Builder().withEnchantment(Enchantments.WIND_BURST))
                        )
