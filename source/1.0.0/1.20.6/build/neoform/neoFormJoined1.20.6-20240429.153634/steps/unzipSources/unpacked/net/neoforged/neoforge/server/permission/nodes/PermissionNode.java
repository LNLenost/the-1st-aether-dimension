 ...
 * That instance should then be reused every-time a permission check needs to be performed via {@link PermissionAPI#getPermission(ServerPlayer, PermissionNode, PermissionDynamicContext[])}.</p>
 */
