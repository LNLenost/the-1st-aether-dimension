...
public abstract class AgeableListModel<E extends Entity> extends EntityModel<E> {
    ...
    public void renderToBuffer(
        ...
        if (this.young) {
            ...
            this.headParts().forEach(p_102081_ -> p_102081_.render(p_102034_, p_102035_, p_102036_, p_102037_, p_102038_, p_102039_, p_102040_, p_102041_));
            p_102034_.popPose();
            p_102034_.pushPose();
            float f1 = 1.0F / this.babyBodyScale;
            p_102034_.scale(f1, f1, f1);
            p_102034_.translate(0.0F, this.bodyYOffset / 16.0F, 0.0F);
            this.bodyParts().forEach(p_102071_ -> p_102071_.render(p_102034_, p_102035_, p_102036_, p_102037_, p_102038_, p_102039_, p_102040_, p_102041_));
            p_102034_.popPose();
        } else {
            this.headParts().forEach(p_102061_ -> p_102061_.render(p_102034_, p_102035_, p_102036_, p_102037_, p_102038_, p_102039_, p_102040_, p_102041_));
            this.bodyParts().forEach(p_102051_ -> p_102051_.render(p_102034_, p_102035_, p_102036_, p_102037_, p_102038_, p_102039_, p_102040_, p_102041_));
        }
    }
