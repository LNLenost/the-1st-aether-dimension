...
public class AnimalPanic<E extends PathfinderMob> extends Behavior<E> {
    ...
    private static final Predicate<PathfinderMob> DEFAULT_SHOULD_PANIC_PREDICATE = p_337707_ -> p_337707_.getLastHurtByMob() != null
            || p_337707_.isFreezing()
            || p_337707_.isOnFire();
    private final float speedMultiplier;
    private final Predicate<E> shouldPanic;

    public AnimalPanic(float p_147385_) {
        this(p_147385_, DEFAULT_SHOULD_PANIC_PREDICATE::test);
    }

    public AnimalPanic(float p_275357_, Predicate<E> p_275369_) {
    ...
    protected boolean checkExtraStartConditions(ServerLevel p_275286_, E p_275721_) {
        return this.shouldPanic.test(p_275721_)
            && (p_275721_.getBrain().hasMemoryValue(MemoryModuleType.HURT_BY) || p_275721_.getBrain().hasMemoryValue(MemoryModuleType.IS_PANICKING));
    }
