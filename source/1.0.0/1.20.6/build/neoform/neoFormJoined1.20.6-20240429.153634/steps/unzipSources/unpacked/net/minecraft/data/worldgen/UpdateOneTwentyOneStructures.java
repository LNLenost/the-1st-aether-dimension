...
public class UpdateOneTwentyOneStructures {
    public static void bootstrap(BootstrapContext<Structure> p_321598_) {
        HolderGetter<Biome> holdergetter = p_321598_.lookup(Registries.BIOME);
        HolderGetter<StructureTemplatePool> holdergetter1 = p_321598_.lookup(Registries.TEMPLATE_POOL);
        p_321598_.register(
            ...
            new JigsawStructure(
                Structures.structure(
                    ...
                    Arrays.stream(MobCategory.values())
                        .collect(
                            Collectors.toMap(
                                p_311885_ -> (MobCategory)p_311885_,
