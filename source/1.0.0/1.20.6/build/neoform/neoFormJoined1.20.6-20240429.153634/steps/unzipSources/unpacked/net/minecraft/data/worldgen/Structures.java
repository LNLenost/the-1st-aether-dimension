...
public class Structures {
    public static Structure.StructureSettings structure(
        HolderSet<Biome> p_256015_, Map<MobCategory, StructureSpawnOverride> p_256297_, GenerationStep.Decoration p_255729_, TerrainAdjustment p_255865_
    ) {
    ...
    public static void bootstrap(BootstrapContext<Structure> p_321517_) {
        HolderGetter<Biome> holdergetter = p_321517_.lookup(Registries.BIOME);
        HolderGetter<StructureTemplatePool> holdergetter1 = p_321517_.lookup(Registries.TEMPLATE_POOL);
        p_321517_.register(
        ...
        p_321517_.register(BuiltinStructures.IGLOO, new IglooStructure(structure(holdergetter.getOrThrow(BiomeTags.HAS_IGLOO), TerrainAdjustment.NONE)));
        p_321517_.register(
        ...
        p_321517_.register(BuiltinStructures.END_CITY, new EndCityStructure(structure(holdergetter.getOrThrow(BiomeTags.HAS_END_CITY), TerrainAdjustment.NONE)));
        p_321517_.register(
