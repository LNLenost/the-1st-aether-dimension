...
public class Font implements net.neoforged.neoforge.client.extensions.IFontExtension {
    ...
    public int drawInBatch(
        ...
        return this.drawInBatch(
            p_272751_, p_272661_, p_273129_, p_273272_, p_273209_, p_272940_, p_273017_, p_272608_, p_273365_, p_272755_, this.isBidirectional()
        );
    }
    ...
    public int drawInBatch(
        ...
        return this.drawInBatch(
            p_273032_.getVisualOrderText(), p_273249_, p_273594_, p_273714_, p_273050_, p_272974_, p_273695_, p_272782_, p_272603_, p_273632_
        );
    }
        ...
        public boolean accept(int p_92967_, Style p_92968_, int p_92969_) {
            ...
            if (!(bakedglyph instanceof EmptyGlyph)) {
                ...
                Font.this.renderChar(
                    bakedglyph, flag, p_92968_.isItalic(), f5, this.x + f4, this.y + f4, this.pose, vertexconsumer, f, f1, f2, f3, this.packedLightCoords
                );
            }
