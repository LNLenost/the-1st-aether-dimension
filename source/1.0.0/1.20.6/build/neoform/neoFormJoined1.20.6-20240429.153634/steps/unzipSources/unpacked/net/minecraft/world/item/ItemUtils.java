...
public class ItemUtils {
    ...
    public static void onContainerDestroyed(ItemEntity p_150953_, Iterable<ItemStack> p_340959_) {
        Level level = p_150953_.level();
        if (!level.isClientSide) {
            p_340959_.forEach(p_337935_ -> level.addFreshEntity(new ItemEntity(level, p_150953_.getX(), p_150953_.getY(), p_150953_.getZ(), p_337935_)));
        }
    }
}
