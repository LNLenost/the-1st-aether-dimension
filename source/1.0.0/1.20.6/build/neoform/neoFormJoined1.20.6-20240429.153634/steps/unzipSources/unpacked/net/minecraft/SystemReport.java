...
public class SystemReport {
    ...
    private void putVirtualMemory(VirtualMemory p_143550_) {
        this.setDetail("Virtual memory max (MB)", () -> String.format(Locale.ROOT, "%.2f", (float)p_143550_.getVirtualMax() / 1048576.0F));
        this.setDetail("Virtual memory used (MB)", () -> String.format(Locale.ROOT, "%.2f", (float)p_143550_.getVirtualInUse() / 1048576.0F));
        this.setDetail("Swap memory total (MB)", () -> String.format(Locale.ROOT, "%.2f", (float)p_143550_.getSwapTotal() / 1048576.0F));
        this.setDetail("Swap memory used (MB)", () -> String.format(Locale.ROOT, "%.2f", (float)p_143550_.getSwapUsed() / 1048576.0F));
    }
