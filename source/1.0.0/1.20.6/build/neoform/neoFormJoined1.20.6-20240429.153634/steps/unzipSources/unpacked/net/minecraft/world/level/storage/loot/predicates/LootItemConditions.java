...
public class LootItemConditions {
    ...
    private static LootItemConditionType register(String p_81832_, MapCodec<? extends LootItemCondition> p_338774_) {
        return Registry.register(BuiltInRegistries.LOOT_CONDITION_TYPE, new ResourceLocation(p_81832_), new LootItemConditionType(p_338774_));
    }
}
