...
public class EndPlacements {
    ...
    public static void bootstrap(BootstrapContext<PlacedFeature> p_321711_) {
        HolderGetter<ConfiguredFeature<?, ?>> holdergetter = p_321711_.lookup(Registries.CONFIGURED_FEATURE);
        ...
        PlacementUtils.register(p_321711_, END_SPIKE, holder, BiomeFilter.biome());
        ...
        PlacementUtils.register(
            p_321711_, CHORUS_PLANT, holder2, CountPlacement.of(UniformInt.of(0, 4)), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome()
        );
        PlacementUtils.register(
            p_321711_,
