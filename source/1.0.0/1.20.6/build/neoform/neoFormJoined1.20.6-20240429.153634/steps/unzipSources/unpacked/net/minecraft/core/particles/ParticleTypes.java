...
public class ParticleTypes {
    ...
    public static final ParticleType<DustParticleOptions> DUST = register(
        "dust", false, p_337461_ -> DustParticleOptions.CODEC, p_319435_ -> DustParticleOptions.STREAM_CODEC
    );
    public static final ParticleType<DustColorTransitionOptions> DUST_COLOR_TRANSITION = register(
        "dust_color_transition", false, p_337463_ -> DustColorTransitionOptions.CODEC, p_319436_ -> DustColorTransitionOptions.STREAM_CODEC
    );
    ...
    public static final ParticleType<SculkChargeParticleOptions> SCULK_CHARGE = register(
        "sculk_charge", true, p_337465_ -> SculkChargeParticleOptions.CODEC, p_319434_ -> SculkChargeParticleOptions.STREAM_CODEC
    );
    ...
    public static final ParticleType<VibrationParticleOption> VIBRATION = register(
        "vibration", true, p_337464_ -> VibrationParticleOption.CODEC, p_319438_ -> VibrationParticleOption.STREAM_CODEC
    );
    ...
    public static final ParticleType<ShriekParticleOption> SHRIEK = register(
        "shriek", false, p_337462_ -> ShriekParticleOption.CODEC, p_319437_ -> ShriekParticleOption.STREAM_CODEC
    );
    ...
    private static <T extends ParticleOptions> ParticleType<T> register(
        ...
        final Function<ParticleType<T>, StreamCodec<? super RegistryFriendlyByteBuf, T>> p_320791_
    ) {
