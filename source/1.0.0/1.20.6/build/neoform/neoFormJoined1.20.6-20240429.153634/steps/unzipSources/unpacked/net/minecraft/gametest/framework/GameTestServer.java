...
public class GameTestServer extends MinecraftServer {
    ...
    private static final GameRules TEST_GAME_RULES = Util.make(new GameRules(), p_341567_ -> {
        p_341567_.getRule(GameRules.RULE_DOMOBSPAWNING).set(false, null);
        p_341567_.getRule(GameRules.RULE_WEATHER_CYCLE).set(false, null);
        p_341567_.getRule(GameRules.RULE_RANDOMTICKING).set(0, null);
    });
