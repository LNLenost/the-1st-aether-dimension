...
public abstract class RenderLayer<T extends Entity, M extends EntityModel<T>> {
    ...
    protected static <T extends LivingEntity> void renderColoredCutoutModel(
        ...
        p_117377_.renderToBuffer(
            p_117379_, vertexconsumer, p_117381_, LivingEntityRenderer.getOverlayCoords(p_117382_, 0.0F), p_117383_, p_117384_, p_117385_, 1.0F
        );
    }
