...
public class TrialChambersStructurePools {
    ...
    public static String spawner(String p_312677_) {
        return "trial_chambers/spawner/" + p_312677_;
    }

    public static void bootstrap(BootstrapContext<StructureTemplatePool> p_321754_) {
        HolderGetter<StructureTemplatePool> holdergetter = p_321754_.lookup(Registries.TEMPLATE_POOL);
        ...
        HolderGetter<StructureProcessorList> holdergetter1 = p_321754_.lookup(Registries.PROCESSOR_LIST);
        ...
        PoolAliasBindings.registerTargetsAsPools(p_321754_, holder, ALIAS_BINDINGS);
    }
}
