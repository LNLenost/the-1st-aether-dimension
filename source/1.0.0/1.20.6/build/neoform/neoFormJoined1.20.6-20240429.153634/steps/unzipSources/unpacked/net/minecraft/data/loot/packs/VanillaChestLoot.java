...
public class VanillaChestLoot implements LootTableSubProvider {
    @Override
    public void generate(HolderLookup.Provider p_332059_, BiConsumer<ResourceKey<LootTable>, LootTable.Builder> p_250931_) {
        p_250931_.accept(
        ...
        p_250931_.accept(BuiltInLootTables.BASTION_BRIDGE, bastionBridgeLootTable());
        p_250931_.accept(BuiltInLootTables.BASTION_HOGLIN_STABLE, bastionHoglinStableLootTable());
        p_250931_.accept(BuiltInLootTables.BASTION_OTHER, bastionOtherLootTable());
        p_250931_.accept(BuiltInLootTables.BASTION_TREASURE, bastionTreasureLootTable());
        p_250931_.accept(
        ...
        p_250931_.accept(BuiltInLootTables.ANCIENT_CITY, ancientCityLootTable());
        p_250931_.accept(
        ...
        p_250931_.accept(BuiltInLootTables.DESERT_PYRAMID, desertPyramidLootTable());
        p_250931_.accept(BuiltInLootTables.END_CITY_TREASURE, endCityTreasureLootTable());
        p_250931_.accept(
        ...
        p_250931_.accept(BuiltInLootTables.JUNGLE_TEMPLE, jungleTempleLootTable());
        p_250931_.accept(
        ...
        p_250931_.accept(BuiltInLootTables.NETHER_BRIDGE, netherBridgeLootTable());
        p_250931_.accept(BuiltInLootTables.PILLAGER_OUTPOST, pillagerOutpostLootTable());
        p_250931_.accept(BuiltInLootTables.SHIPWRECK_MAP, shipwreckMapLootTable());
        p_250931_.accept(BuiltInLootTables.SHIPWRECK_SUPPLY, shipwreckSupplyLootTable());
        p_250931_.accept(BuiltInLootTables.SHIPWRECK_TREASURE, shipwreckTreasureLootTable());
        p_250931_.accept(
        ...
        p_250931_.accept(BuiltInLootTables.STRONGHOLD_CORRIDOR, strongholdCorridorLootTable());
        p_250931_.accept(
        ...
        p_250931_.accept(BuiltInLootTables.STRONGHOLD_LIBRARY, strongholdLibraryLootTable());
        p_250931_.accept(
        ...
        p_250931_.accept(BuiltInLootTables.WOODLAND_MANSION, woodlandMansionLootTable());
        p_250931_.accept(
        ...
        p_250931_.accept(BuiltInLootTables.TRIAL_CHAMBERS_REWARD, LootTable.lootTable());
        p_250931_.accept(BuiltInLootTables.TRIAL_CHAMBERS_REWARD_COMMON, LootTable.lootTable());
        p_250931_.accept(BuiltInLootTables.TRIAL_CHAMBERS_REWARD_RARE, LootTable.lootTable());
        p_250931_.accept(BuiltInLootTables.TRIAL_CHAMBERS_REWARD_UNIQUE, LootTable.lootTable());
        p_250931_.accept(BuiltInLootTables.TRIAL_CHAMBERS_REWARD_OMINOUS, LootTable.lootTable());
        p_250931_.accept(BuiltInLootTables.TRIAL_CHAMBERS_REWARD_OMINOUS_COMMON, LootTable.lootTable());
        p_250931_.accept(BuiltInLootTables.TRIAL_CHAMBERS_REWARD_OMINOUS_RARE, LootTable.lootTable());
        p_250931_.accept(BuiltInLootTables.TRIAL_CHAMBERS_REWARD_OMINOUS_UNIQUE, LootTable.lootTable());
        p_250931_.accept(BuiltInLootTables.TRIAL_CHAMBERS_SUPPLY, LootTable.lootTable());
        p_250931_.accept(BuiltInLootTables.TRIAL_CHAMBERS_CORRIDOR, LootTable.lootTable());
        p_250931_.accept(BuiltInLootTables.TRIAL_CHAMBERS_ENTRANCE, LootTable.lootTable());
        p_250931_.accept(BuiltInLootTables.TRIAL_CHAMBERS_INTERSECTION, LootTable.lootTable());
        p_250931_.accept(BuiltInLootTables.TRIAL_CHAMBERS_INTERSECTION_BARREL, LootTable.lootTable());
        p_250931_.accept(BuiltInLootTables.TRIAL_CHAMBERS_CHAMBER_DISPENSER, LootTable.lootTable());
        p_250931_.accept(BuiltInLootTables.TRIAL_CHAMBERS_CORRIDOR_DISPENSER, LootTable.lootTable());
        p_250931_.accept(BuiltInLootTables.TRIAL_CHAMBERS_WATER_DISPENSER, LootTable.lootTable());
        p_250931_.accept(BuiltInLootTables.TRIAL_CHAMBERS_CORRIDOR_POT, LootTable.lootTable());
        spawnerLootTables(p_250931_);
    }

    public static void spawnerLootTables(BiConsumer<ResourceKey<LootTable>, LootTable.Builder> p_311958_) {
        p_311958_.accept(BuiltInLootTables.SPAWNER_TRIAL_CHAMBER_KEY, LootTable.lootTable());
        p_311958_.accept(BuiltInLootTables.SPAWNER_TRIAL_CHAMBER_CONSUMABLES, LootTable.lootTable());
        p_311958_.accept(BuiltInLootTables.SPAWNER_OMINOUS_TRIAL_CHAMBER_KEY, LootTable.lootTable());
        p_311958_.accept(BuiltInLootTables.SPAWNER_OMINOUS_TRIAL_CHAMBER_CONSUMABLES, LootTable.lootTable());
        p_311958_.accept(BuiltInLootTables.SPAWNER_TRIAL_ITEMS_TO_DROP_WHEN_OMINOUS, LootTable.lootTable());
    }
