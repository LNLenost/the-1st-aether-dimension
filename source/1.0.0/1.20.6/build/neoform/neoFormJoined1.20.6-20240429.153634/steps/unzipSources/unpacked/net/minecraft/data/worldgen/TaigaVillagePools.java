...
public class TaigaVillagePools {
    ...
    public static void bootstrap(BootstrapContext<StructureTemplatePool> p_321812_) {
        HolderGetter<PlacedFeature> holdergetter = p_321812_.lookup(Registries.PLACED_FEATURE);
        ...
        HolderGetter<StructureProcessorList> holdergetter1 = p_321812_.lookup(Registries.PROCESSOR_LIST);
        ...
        HolderGetter<StructureTemplatePool> holdergetter2 = p_321812_.lookup(Registries.TEMPLATE_POOL);
