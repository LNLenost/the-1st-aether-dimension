        ...
        if (p_283370_ != SpectatorMenu.EMPTY_SLOT) {
            ...
            if (i > 3 && p_283370_.isEnabled()) {
                ...
                p_281411_.drawString(
                    this.minecraft.font, component, p_281853_ + 19 - 2 - this.minecraft.font.width(component), (int)p_282693_ + 6 + 3, 16777215 + (i << 24)
                );
            }
        }
    }
    ...
    public void renderTooltip(GuiGraphics p_283107_) {
        ...
        if (i > 3 && this.menu != null) {
            ...
            if (component != null) {
                ...
                p_283107_.fill(k - 2, l - 2, k + j + 2, l + 9 + 2, this.minecraft.options.getBackgroundColor(0));
                p_283107_.drawString(this.minecraft.font, component, k, l, 16777215 + (i << 24));
            }
        }
    }
