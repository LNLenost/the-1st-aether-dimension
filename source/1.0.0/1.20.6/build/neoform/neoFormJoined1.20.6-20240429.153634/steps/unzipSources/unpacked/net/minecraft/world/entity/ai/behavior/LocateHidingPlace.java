    ...
    public static OneShot<LivingEntity> create(int p_259202_, float p_259881_, int p_259982_) {
        return BehaviorBuilder.create(
            p_258505_ -> p_258505_.group(
                    ...
                    .apply(
                        p_258505_,
                        (p_258484_, p_258485_, p_258486_, p_258487_, p_258488_, p_258489_, p_258490_) -> (p_337754_, p_337755_, p_337756_) -> {
                                p_337754_.getPoiManager()
                                    .find(
                                        p_217258_ -> p_217258_.is(PoiTypes.HOME),
                                        p_23425_ -> true,
                                        p_337755_.blockPosition(),
                                        p_259982_ + 1,
                                        PoiManager.Occupancy.ANY
                                    )
                                    .filter(p_337728_ -> p_337728_.closerToCenterThan(p_337755_.position(), (double)p_259982_))
                                    .or(
                                        () -> p_337754_.getPoiManager()
                                                .getRandom(
                                    ...
                                    .ifPresent(p_340733_ -> {
                                        ...
                                        p_258489_.erase();
                                        p_258490_.erase();
                                        p_258486_.set(GlobalPos.of(p_337754_.dimension(), p_340733_));
                                        if (!p_340733_.closerToCenterThan(p_337755_.position(), (double)p_259982_)) {
                                            p_258484_.set(new WalkTarget(p_340733_, p_259881_, p_259982_));
                                        }
                                    });
                                return true;
                            }
