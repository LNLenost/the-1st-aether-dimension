...
public class BastionSharedPools {
    public static void bootstrap(BootstrapContext<StructureTemplatePool> p_321501_) {
        HolderGetter<StructureTemplatePool> holdergetter = p_321501_.lookup(Registries.TEMPLATE_POOL);
