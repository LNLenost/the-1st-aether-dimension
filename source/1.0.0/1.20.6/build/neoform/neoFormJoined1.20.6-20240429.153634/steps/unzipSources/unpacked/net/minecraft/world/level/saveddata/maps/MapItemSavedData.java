...
public class MapItemSavedData extends SavedData {
    ...
    public void tickCarriedBy(Player p_77919_, ItemStack p_77920_) {
        ...
        if (!this.decorations.keySet().containsAll(mapdecorations.decorations().keySet())) {
            mapdecorations.decorations().forEach((p_338113_, p_338114_) -> {
                if (!this.decorations.containsKey(p_338113_)) {
                    this.addDecoration(p_338114_.type(), p_77919_.level(), p_338113_, p_338114_.x(), p_338114_.z(), (double)p_338114_.rotation(), null);
                }
            });
        }
    }
