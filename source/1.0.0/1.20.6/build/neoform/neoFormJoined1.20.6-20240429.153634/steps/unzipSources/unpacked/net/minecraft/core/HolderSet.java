...
public interface HolderSet<T> extends Iterable<Holder<T>>, net.neoforged.neoforge.common.extensions.IHolderSetExtension<T> {
    ...
    static <E, T> HolderSet.Direct<T> direct(Function<E, Holder<T>> p_205804_, Collection<E> p_298495_) {
        return direct(p_298495_.stream().map(p_205804_).toList());
    }
    ...
    public static final class Direct<T> extends HolderSet.ListBacked<T> {
        ...
        public boolean equals(Object p_332659_) {
            if (this == p_332659_) {
                ...
                if (p_332659_ instanceof HolderSet.Direct<?> direct && this.contents.equals(direct.contents)) {
                    return true;
                }
