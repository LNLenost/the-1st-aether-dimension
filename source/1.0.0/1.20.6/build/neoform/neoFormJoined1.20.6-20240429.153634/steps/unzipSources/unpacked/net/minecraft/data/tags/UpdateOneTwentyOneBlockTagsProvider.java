...
public class UpdateOneTwentyOneBlockTagsProvider extends IntrinsicHolderTagsProvider<Block> {
    public UpdateOneTwentyOneBlockTagsProvider(
        PackOutput p_307594_, CompletableFuture<HolderLookup.Provider> p_307614_, CompletableFuture<TagsProvider.TagLookup<Block>> p_307589_
    ) {
        super(p_307594_, Registries.BLOCK, p_307614_, p_307589_, p_307562_ -> p_307562_.builtInRegistryHolder().key());
    }

    @Override
    protected void addTags(HolderLookup.Provider p_307475_) {
