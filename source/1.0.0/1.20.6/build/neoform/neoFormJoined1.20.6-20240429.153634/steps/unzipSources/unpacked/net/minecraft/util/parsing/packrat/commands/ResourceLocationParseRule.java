...
public class ResourceLocationParseRule implements Rule<StringReader, ResourceLocation> {
    ...
    @Override
    public Optional<ResourceLocation> parse(ParseState<StringReader> p_335633_) {
        p_335633_.input().skipWhitespace();

        try {
            return Optional.of(ResourceLocation.readNonEmpty(p_335633_.input()));
