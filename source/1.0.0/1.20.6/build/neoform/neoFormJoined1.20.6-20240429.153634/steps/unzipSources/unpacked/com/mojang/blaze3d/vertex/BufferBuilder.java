...
public class BufferBuilder extends DefaultedVertexConsumer implements BufferVertexConsumer {
    ...
    public void vertex(
        ...
        if (this.defaultColorSet) {
            ...
            int i;
            if (this.fullFormat) {
                this.putShort(24, (short)(p_85680_ & 65535));
                this.putShort(26, (short)(p_85680_ >> 16 & 65535));
                i = 28;
            } else {
                i = 24;
            }

            this.putShort(i + 0, (short)(p_85681_ & 65535));
            this.putShort(i + 2, (short)(p_85681_ >> 16 & 65535));
            ...
            super.vertex(
                p_85671_, p_85672_, p_85673_, p_85674_, p_85675_, p_85676_, p_85677_, p_85678_, p_85679_, p_85680_, p_85681_, p_85682_, p_85683_, p_85684_
            );
        }
    }
