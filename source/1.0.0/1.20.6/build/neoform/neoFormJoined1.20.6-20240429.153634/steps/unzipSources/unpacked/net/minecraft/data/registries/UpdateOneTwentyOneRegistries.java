...
public class UpdateOneTwentyOneRegistries {
    ...
    public static CompletableFuture<RegistrySetBuilder.PatchedRegistries> createLookup(CompletableFuture<HolderLookup.Provider> p_307482_) {
        return RegistryPatchGenerator.createLookup(p_307482_, BUILDER);
    }
}
