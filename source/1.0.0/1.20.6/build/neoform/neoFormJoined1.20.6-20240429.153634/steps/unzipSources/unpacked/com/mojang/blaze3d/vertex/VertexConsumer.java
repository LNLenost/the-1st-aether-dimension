...
public interface VertexConsumer extends net.neoforged.neoforge.client.extensions.IVertexConsumerExtension {
    ...
    default VertexConsumer color(int p_193480_) {
        return this.color(
            FastColor.ARGB32.red(p_193480_), FastColor.ARGB32.green(p_193480_), FastColor.ARGB32.blue(p_193480_), FastColor.ARGB32.alpha(p_193480_)
        );
    }
    ...
    default VertexConsumer vertex(PoseStack.Pose p_324031_, float p_323557_, float p_324535_, float p_324157_) {
    ...
    default VertexConsumer normal(PoseStack.Pose p_323641_, float p_254430_, float p_253877_, float p_254167_) {
