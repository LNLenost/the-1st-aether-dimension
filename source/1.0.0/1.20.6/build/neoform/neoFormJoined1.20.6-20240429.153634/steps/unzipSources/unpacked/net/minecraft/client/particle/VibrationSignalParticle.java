...
public class VibrationSignalParticle extends TextureSheetParticle {
    ...
    public void render(VertexConsumer p_172475_, Camera p_172476_, float p_172477_) {
        ...
        this.renderSignal(p_172475_, p_172476_, p_172477_, p_253355_ -> p_253355_.rotateY(f1).rotateX(-f2).rotateY(f));
        this.renderSignal(p_172475_, p_172476_, p_172477_, p_253351_ -> p_253351_.rotateY((float) -Math.PI + f1).rotateX(f2).rotateY(f));
    }
    ...
    private void renderSignal(VertexConsumer p_172479_, Camera p_172480_, float p_172481_, Consumer<Quaternionf> p_172482_) {
        ...
        p_172479_.vertex((double)avector3f[0].x(), (double)avector3f[0].y(), (double)avector3f[0].z())
            .uv(f7, f5)
            .color(this.rCol, this.gCol, this.bCol, this.alpha)
            .uv2(j)
            .endVertex();
        p_172479_.vertex((double)avector3f[1].x(), (double)avector3f[1].y(), (double)avector3f[1].z())
            .uv(f7, f4)
            .color(this.rCol, this.gCol, this.bCol, this.alpha)
            .uv2(j)
            .endVertex();
        p_172479_.vertex((double)avector3f[2].x(), (double)avector3f[2].y(), (double)avector3f[2].z())
            .uv(f6, f4)
            .color(this.rCol, this.gCol, this.bCol, this.alpha)
            .uv2(j)
            .endVertex();
        p_172479_.vertex((double)avector3f[3].x(), (double)avector3f[3].y(), (double)avector3f[3].z())
            .uv(f6, f5)
            .color(this.rCol, this.gCol, this.bCol, this.alpha)
            .uv2(j)
            .endVertex();
