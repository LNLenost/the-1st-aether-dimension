...
public class RabbitModel<T extends Rabbit> extends EntityModel<T> {
    ...
    public void renderToBuffer(
        PoseStack p_103555_, VertexConsumer p_103556_, int p_103557_, int p_103558_, float p_103559_, float p_103560_, float p_103561_, float p_103562_
    ) {
        if (this.young) {
            float f = 1.5F;
            p_103555_.pushPose();
            ...
            ImmutableList.of(this.head, this.leftEar, this.rightEar, this.nose)
                .forEach(p_103597_ -> p_103597_.render(p_103555_, p_103556_, p_103557_, p_103558_, p_103559_, p_103560_, p_103561_, p_103562_));
            p_103555_.popPose();
            p_103555_.pushPose();
            ...
            ImmutableList.of(
                ...
                .forEach(p_103587_ -> p_103587_.render(p_103555_, p_103556_, p_103557_, p_103558_, p_103559_, p_103560_, p_103561_, p_103562_));
            p_103555_.popPose();
        } else {
            p_103555_.pushPose();
            ...
            ImmutableList.of(
                ...
                .forEach(p_103572_ -> p_103572_.render(p_103555_, p_103556_, p_103557_, p_103558_, p_103559_, p_103560_, p_103561_, p_103562_));
            p_103555_.popPose();
        }
    }
